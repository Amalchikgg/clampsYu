...
const Product = ({
  ...
  return (
    ...
    >
      <div
        className={`mb-[18px] mobile:mb-[11px] border mobile:w-[170px] mobile:px-0 mobile:h-[254px] border-[#1A1921] flex items-center flex-col w-[295px] h-[433px] tablet:w-[305px] tablet:h-[471px] ${
